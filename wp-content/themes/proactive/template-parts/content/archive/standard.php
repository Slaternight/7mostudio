 ...
 * @package Case-Themes
 */
$archive_readmore_text = proactive()->get_theme_opt('archive_readmore_text', esc_html__('Read More', 'proactive'));
$featured_img_size = proactive()->get_theme_opt('featured_img_size', '960x460');
...
<article id="post-<?php the_ID(); ?>" <?php post_class('pxl---post pxl-item--archive pxl-item--standard'); ?>>
    ...
    <div class="pxl-item--holder">
        ...
        <?php proactive()->blog->get_archive_meta(); ?>
        <div class="pxl-item--excerpt">
            <?php
                proactive()->blog->get_excerpt();
                wp_link_pages( array(
        ...
        <div class="pxl-item--readmore">
            <a class="btn btn-text-parallax btn-icon-box" href="<?php echo esc_url( get_permalink()); ?>">
                <span class="pxl--btn-text"><?php echo proactive_html($archive_readmore_text); ?></span>
