<?php 
$logo_m = proactive()->get_opt( 'logo_m', ['url' => get_template_directory_uri().'/assets/img/logo.png', 'id' => '' ] );
$logo_light_m = proactive()->get_opt( 'logo_light_m', ['url' => get_template_directory_uri().'/assets/img/logo-light.png', 'id' => '' ] );
$p_menu = proactive()->get_page_opt('p_menu');
$header_mobile = proactive()->get_page_opt('header_mobile', 'show');
$sticky_scroll = proactive()->get_opt('sticky_scroll');
...
$page_mobile_style = proactive()->get_page_opt('page_mobile_style');
$opt_mobile_style = proactive()->get_opt('opt_mobile_style');
$mobile_display = proactive()->get_opt('mobile_display');
if(isset($page_mobile_style) && !empty($page_mobile_style) && $page_mobile_style != 'inherit') {
    $opt_mobile_style = $page_mobile_style;
}
$header_mobile_layout = proactive()->get_opt('header_mobile_layout');
$header_mobile_layout_count = (int)proactive()->get_opt('header_mobile_layout');
                    ...
                    <div class="row">
                        ...
                        <div class="pxl-header-menu">
                            <div class="pxl-header-menu-scroll">
                                ...
                                <?php proactive_header_mobile_search_form(); ?>
