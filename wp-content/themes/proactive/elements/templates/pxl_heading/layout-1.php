...
$sg_service_title = proactive()->get_theme_opt('sg_service_title', 'default');
$sg_service_title_text = proactive()->get_theme_opt('sg_service_title_text');

$sg_portfolio_title = proactive()->get_theme_opt('sg_portfolio_title', 'default');
$sg_portfolio_title_text = proactive()->get_theme_opt('sg_portfolio_title_text');
?>
			...
			<span class="pxl-heading--text">
				...
				<?php } else { ?>
					<?php if($settings['source_type'] == 'text' && !empty($editor_title)) {
						...
						$titles = proactive()->page->get_title();
