...
<?php if(isset($settings['imgs']) && !empty($settings['imgs']) && count($settings['imgs'])): 
    ...
    <div id="pxl-image-carousel-<?php echo esc_attr($pxl_g_id); ?>" class="pxl-swiper-slider pxl-image-carousel pxl-image-carousel1 pxl-swiper-nogap" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_html__('DRAG', 'proactive'); ?>"<?php endif; ?>>
