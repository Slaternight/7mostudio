                            ...
                            <?php if($show_author == 'true'): ?>
                                <div class="pxl-post--author pxl-mr-22">
                                    <a href="<?php echo esc_url(get_author_posts_url($post->post_author, $author->user_nicename)); ?>">
                                        <i class="flaticon-user pxl-mr-6 text-gradient"></i><?php echo esc_html__('By', 'proactive').' '.esc_html($author->display_name); ?>
                                    </a>
                                </div>
                            <?php endif; ?>
                            <?php if($show_comment == 'true'): ?>
                                <div class="pxl-post--comment">
                                    <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>#comments">
                                        ...
                                        <?php if($comment_count > 1) { echo esc_html__('Comments', 'proactive'); } ?>
                                        <?php if($comment_count == 1 || $comment_count == 0) { echo esc_html__('Comment', 'proactive'); } ?>
                                    </a>
                                </div>
                            <?php endif; ?>
                        </div>
