...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-service-carousel pxl-service-carousel1 pxl-service-style1" <?php if($drap !== false): ?>data-cursor-drap="<?php echo esc_html__('DRAG', 'proactive'); ?>"<?php endif; ?>>
