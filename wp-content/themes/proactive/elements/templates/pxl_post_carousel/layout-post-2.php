...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-slider pxl-post-carousel pxl-post-carousel2 pxl-blog-style2" <?php if($settings['drap'] !== false) : ?>data-cursor-drap="<?php echo esc_html__('DRAG', 'proactive'); ?>"<?php endif; ?>>
                                        ...
                                        <?php if($show_author == 'true'): ?>
                                            <div class="pxl-post--author pxl-flex">
                                                ...
                                                <div class="pxl-author-meta">
                                                    <span><?php echo esc_html__('By Post', 'proactive'); ?></span>
