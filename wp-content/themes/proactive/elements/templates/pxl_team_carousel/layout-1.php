...
<?php if(isset($settings['team']) && !empty($settings['team']) && count($settings['team'])): 
    ...
    <div class="pxl-swiper-slider pxl-team pxl-team-carousel1 pxl-team-layout1" <?php if($drap !== false) : ?>data-cursor-drap="<?php echo esc_html__('DRAG', 'proactive'); ?>"<?php endif; ?>>
