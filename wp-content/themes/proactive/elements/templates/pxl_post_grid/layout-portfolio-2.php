...
if( count($posts) <= 0){
    echo '<div class="pxl-no-post-grid">'.esc_html__( 'No Post Found', 'proactive' ). '</div>';
    return;
} ?>
    ...
    <?php if ($select_post_by == 'term_selected' && $filter == "true"): ?>
        <div class="pxl-grid-filter <?php echo esc_attr($filter_type) ?> style-1">
            <div class="pxl--filter-inner">
                <span class="filter-label"><?php echo esc_html__('Filter By :', 'proactive'); ?></span>
