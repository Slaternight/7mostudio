<?php 
/* Start Section */
add_action( 'elementor/element/section/section_structure/after_section_end', 'proactive_add_custom_section_controls' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'proactive_add_custom_section_overlay_color' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'proactive_add_custom_section_overlay_img' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'proactive_add_custom_section_divider' ); 
add_action( 'elementor/element/section/section_structure/after_section_end', 'proactive_add_custom_section_particles' );
add_action( 'elementor/element/section/section_structure/after_section_end', 'proactive_add_custom_section_effect_image' );
function proactive_add_custom_section_controls( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_pxl',
        [
            'label' => esc_html__( 'Proactive General Settings', 'proactive' ),
    ...
    if ( get_post_type( get_the_ID()) === 'pxl-template' && get_post_meta( get_the_ID(), 'template_type', true ) === 'header-mobile') {
        ...
        $element->add_control(
            'pxl_header_type',
            [
                'label' => esc_html__( 'Header Type', 'proactive' ),
                'type'  => \Elementor\Controls_Manager::SELECT,
                'hide_in_inner' => true,
                'options'      => array(
                    ''          => esc_html__( 'Select Type', 'proactive' ),
                    'sticky'      => esc_html__( 'Header Sticky', 'proactive' ),
                ),
                'default'      => '',
            ]
        );
    ...
    $element->add_control(
        'row_scroll_fixed',
        [
            'label'   => esc_html__( 'Column Fixed', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'proactive' ),
                'fixed'   => esc_html__( 'Yes', 'proactive' ),
            ),
    ...
    $element->add_control(
        'row_zoom_point',
        [
            'label'   => esc_html__( 'Zoom Point', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'description' => 'Background color displayed on scroll.',
            'options' => array(
                'false'        => esc_html__( 'No', 'proactive' ),
                'true'   => esc_html__( 'Yes', 'proactive' ),
            ),
            'default'      => 'false',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Overflow', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'visible'        => esc_html__( 'Visible', 'proactive' ),
                'hidden'   => esc_html__( 'Hidden', 'proactive' ),
            ),
            'default'      => 'visible', 
            'separator' => 'after',
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Section Fixed Scroll', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'proactive' ),
                'top'        => esc_html__( 'Top', 'proactive' ),
                'bottom'   => esc_html__( 'Bottom', 'proactive' ),
            ),
            'default'      => 'none', 
            'separator' => 'after',
    ...
    $element->add_control(
        'pxl_parallax_bg_img',
        [
            'label' => esc_html__( 'Parallax Background Image', 'proactive' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position', 'proactive' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'X Position', 'proactive' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Y Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'default' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Size', 'proactive' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'proactive' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Width', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,  
            'hide_in_inner' => true,
            'size_units' => [ 'px', 'em', '%', 'vw' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'proactive' ),
            'label_on' => esc_html__( 'Custom', 'proactive' ),
            'return_value' => 'yes',
            'condition'     => [
                'pxl_parallax_bg_img[url]!' => ''
            ] 
    ...
    $element->start_popover();
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Left', 'proactive' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Top', 'proactive' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Right', 'proactive' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
        ...
        $element->add_responsive_control(
            ...
            [
                'label' => esc_html__( 'Bottom', 'proactive' ).' (50px) px,%,vw,auto',
                'type' => 'text',
                'default' => '',
                'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Parallax Background Effect', 'proactive' ),
            'type' => \Elementor\Controls_Manager::POPOVER_TOGGLE,
            'label_off' => esc_html__( 'Default', 'proactive' ),
            'label_on' => esc_html__( 'Custom', 'proactive' ),
            'return_value' => 'yes',
    ...
    $element->start_popover();
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateX', 'proactive' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateY', 'proactive' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'TranslateZ', 'proactive' ).' (-80)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate X', 'proactive' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Y', 'proactive' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Rotate Z', 'proactive' ).' (30)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale X', 'proactive' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Y', 'proactive' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale Z', 'proactive' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scale', 'proactive' ).' (1.2)',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
        ...
        $element->add_control(
            ...
            [
                'label' => esc_html__( 'Scroll From (px)', 'proactive' ).' (350) from offset top',
                'type' => 'text',
                'default' => '',
                'condition'     => [
                    'pxl_parallax_bg_img[url]!' => ''
    ...
    $element->add_responsive_control(
        ...
        [
            'label'      => esc_html__( 'Parallax Opacity (0 - 100)', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ '%' ],
            'range' => [
                '%' => [
    ...
    $element->add_control(
        ...
        [
          'label' => esc_html__( 'Full Content with space from?', 'proactive' ),
          'type'         => \Elementor\Controls_Manager::SELECT,
                'prefix_class' => 'pxl-full-content-with-space-',
                'options'      => array(
                    'none'    => esc_html__( 'None', 'proactive' ),
                    'start'   => esc_html__( 'Start', 'proactive' ),
                    'end'     => esc_html__( 'End', 'proactive' ),
                ),
                'default'      => 'none',
                'condition' => [
                    'layout' => 'full_width'
    ...
    $element->add_control(
        'pxl_container_width',
        [
                'label' => esc_html__('Container Width', 'proactive'),
...
function proactive_add_custom_section_overlay_color( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_color',
        [
            'label' => esc_html__( 'Proactive Overlay Color', 'proactive' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_color_offset',
        [
            'label'   => esc_html__( 'Overlay Color', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'proactive' ),
                'full'   => esc_html__( 'Full', 'proactive' ),
                'skew'   => esc_html__( 'Skew', 'proactive' ),
            ),
    ...
    $element->add_responsive_control(
        'overlay_left_space',
        [
            'label' => esc_html__('Overlay Left Space', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
    ...
    $element->add_responsive_control(
        'overlay_right_space',
        [
            'label' => esc_html__('Overlay Right Space', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px','%' ],
            'range' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overlay Border Radius', 'proactive' ),
...
function proactive_add_custom_section_overlay_img( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_overlay_img',
        [
            'label' => esc_html__( 'Proactive Overlay Image', 'proactive' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'pxl_overlay_display',
        [
            'label'   => esc_html__( 'Overlay Image', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'No', 'proactive' ),
                'image'   => esc_html__( 'Yes', 'proactive' ),
            ),
    ...
    $element->add_control(
        'pxl_overlay_img',
        [
            'label'   => esc_html__( 'Select Image 1', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 1', 'proactive' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'proactive' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 1', 'proactive' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 1', 'proactive' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 1', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_control(
        'pxl_overlay_img2',
        [
            'label'   => esc_html__( 'Select Image 2', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::MEDIA,
            'condition' => [
                'pxl_overlay_display' => ['image'],
            ],
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__( 'Background Position - Image 2', 'proactive' ),
            'type'         => \Elementor\Controls_Manager::SELECT,
            'hide_in_inner' => true,
            'options'      => array(
                ''              => esc_html__( 'Default', 'proactive' ),
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Border Radius - Image 2', 'proactive' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Margin - Image 2', 'proactive' ),
            'type' => \Elementor\Controls_Manager::DIMENSIONS,
            'control_type' => 'responsive',
            'selectors' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Width Image 2', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ '%', 'px' ],
            'range' => [
    ...
    $element->add_responsive_control(
        ...
        [
            'label' => esc_html__('Offset Left - Image 2', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function proactive_add_custom_section_divider( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_divider',
        [
            'label' => esc_html__( 'Proactive Divider', 'proactive' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        'row_divider',
        [
            'label'   => esc_html__( 'Divider', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''        => esc_html__( 'None', 'proactive' ),
                'rounded-top'   => esc_html__( 'Rounded Top', 'proactive' ),
                'angle-top'   => esc_html__( 'Angle Top Left', 'proactive' ),
                'angle-top-right'   => esc_html__( 'Angle Top Right', 'proactive' ),
                'angle-bottom-left'   => esc_html__( 'Angle Bottom Left', 'proactive' ),
                'angle-bottom'   => esc_html__( 'Angle Bottom Right', 'proactive' ),
                'angle-top-bottom'   => esc_html__( 'Angle Top & Bottom Right', 'proactive' ),
                'angle-top-bottom-left'   => esc_html__( 'Angle Top & Bottom Left', 'proactive' ),
                'wave-animation-top'   => esc_html__( 'Wave Animation Top', 'proactive' ),
                'wave-animation-bottom'   => esc_html__( 'Wave Animation Bottom 1', 'proactive' ),
                'wave-animation-bottom2'   => esc_html__( 'Wave Animation Bottom 2', 'proactive' ),
                'curved-top'   => esc_html__( 'Curved Top', 'proactive' ),
                'curved-bottom'   => esc_html__( 'Curved Bottom', 'proactive' ),
                'vertical1'   => esc_html__( 'Divider Vertical', 'proactive' ),
                'curved-arrow'   => esc_html__( 'Curved Arrow', 'proactive' ),
                'curved-arrow-inner-top'   => esc_html__( 'Curved Arrow Inner Top', 'proactive' ),
                'curved-arrow-inner-bottom'   => esc_html__( 'Curved Arrow Inner Bottom', 'proactive' ),
                'divider-border'   => esc_html__( 'Divider Broder Top/Bottom', 'proactive' ),
            ),
    ...
    $element->add_control(
        'divider_color',
        [
            'label' => esc_html__('Divider Color', 'proactive' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_control(
        'divider_color_top',
        [
            'label' => esc_html__('Divider Color Top', 'proactive' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Divider Color Bottom', 'proactive' ),
            'type' => \Elementor\Controls_Manager::COLOR,
            'selectors' => [
    ...
    $element->add_responsive_control(
        'divider_height',
        [
            'label' => esc_html__('Divider Height', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'control_type' => 'responsive',
            'size_units' => [ 'px' ],
            'range' => [
...
function proactive_add_custom_section_particles( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_particles',
        [
            'label' => esc_html__( 'Proactive Particles', 'proactive' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $element->add_control(
        ...
        [
            'label'   => esc_html__( 'Particles', 'proactive' ),
    ...
    $element->add_control(
        'size',
        [
                'label' => esc_html__('Size', 'proactive'),
                'type' => \Elementor\Controls_Manager::NUMBER,
                'default' => 3, 
                'condition' => [
                    'row_particles_display' => ['yes'],
    ...
    $element->add_control(
        'size_random',
        [
                'label' => esc_html__('Size Random', 'proactive'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'default' => 'false',
                'condition' => [
                    'row_particles_display' => ['yes'],
    ...
    $element->add_control(
        'move_direction',
        [
            'label'   => esc_html__( 'Move Direction', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'        => esc_html__( 'None', 'proactive' ),
                'top'        => esc_html__( 'Top', 'proactive' ),
                ...
                'bottom'        => esc_html__( 'Bottom', 'proactive' ),
                'bottom-left'        => esc_html__( 'Bottom Left', 'proactive' ),
                'left'        => esc_html__( 'Left', 'proactive' ),
                'top-left'        => esc_html__( 'Top Left', 'proactive' ),
            ),
            'default'      => 'none',
            'condition' => [
...
function proactive_add_custom_section_effect_image( \Elementor\Element_Base $element) {
     
    $element->start_controls_section(
        'section_effect_image',
        [
            'label' => esc_html__( 'Proactive Effect Images', 'proactive' ),
            'tab' => \Elementor\Controls_Manager::TAB_LAYOUT,
        ]
    );
    ...
    $repeater_img->add_control(
        'image_position', 
        [
            'label' => esc_html__('Image Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'p-top-left' => 'Top Left',
    ...
    $repeater_img->add_control(
        'image_position_top', 
        [
            'label' => esc_html__('Top Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        'image_position_left', 
        [
            'label' => esc_html__('Left Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Bottom Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Right Position', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
            'control_type' => 'responsive',
            'default' => [
    ...
    $repeater_img->add_control(
        'effect_image', 
        [
            'label' => esc_html__('Image Effect', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                '' => 'None',
                'pxl-image-spin' => 'Spin',
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Type', 'proactive' ),
            'type' => \Elementor\Controls_Manager::SELECT,
            'options' => [
                'y' => 'Effect Y',
                'x' => 'Effect X',
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Scroll Value', 'proactive' ),
    ...
    $repeater_img->add_control(
        ...
        [
            'label' => esc_html__('Parallax Hover Value', 'proactive' ),
            'type' => \Elementor\Controls_Manager::TEXT,
            'default' => '40',
            'description' => esc_html__('Enter number.', 'proactive' ),
            'condition' => [
    ...
    $repeater_img->add_control(
        'image_display', 
        [
            'label' => esc_html__('Hide on Screen <= 1400px', 'proactive'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_md', 
        [
            'label' => esc_html__('Hide on Screen <= 1200px', 'proactive'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $repeater_img->add_control(
        'image_display_sm', 
        [
            'label' => esc_html__('Hide on Screen <= 767px', 'proactive'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'default' => 'false',
        ]
    );
    ...
    $element->add_control(
        'row_effect_images',
        [
            'label'   => esc_html__( 'Images', 'proactive' ),
            'type' => \Elementor\Controls_Manager::REPEATER,
...
/* Start Column */
add_action( 'elementor/element/column/layout/after_section_end', 'proactive_add_custom_columns_controls' ); 
function proactive_add_custom_columns_controls( \Elementor\Element_Base $element) {
    $element->start_controls_section(
        'columns_pxl',
        [
            'label' => esc_html__( 'Proactive General Settings', 'proactive' ),
    ...
    $element->add_control(
        'col_content_align',
        [
            'label'   => esc_html__( 'Column Content Align', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                ''           => esc_html__( 'Default', 'proactive' ),
                'start'           => esc_html__( 'Start', 'proactive' ),
                'center'           => esc_html__( 'Center', 'proactive' ),
                'end'           => esc_html__( 'End', 'proactive' ),
            ),
            'default' => '',
    ...
    $element->add_control(
        'col_sticky',
        [
            'label'   => esc_html__( 'Column Sticky', 'proactive' ),
            'type'    => \Elementor\Controls_Manager::SELECT,
            'options' => array(
                'none'           => esc_html__( 'No', 'proactive' ),
                'sticky' => esc_html__( 'Yes', 'proactive' ),
            ),
            'default' => 'none',
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__( 'Sticky Offset Top', 'proactive' ),
            'type' => 'text',
            'description' => esc_html__('Enter number.', 'proactive' ),
            'default'  => '30',
            'selectors' => [
    ...
    $element->add_control(
        ...
        [
            'label' => esc_html__('Overflow Hidden', 'proactive'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
            'label_on' => esc_html__( 'Yes', 'proactive' ),
            'label_off' => esc_html__( 'No', 'proactive' ),
            'return_value' => 'yes',
            'default' => 'no',
            'separator' => 'after',
...
add_action( 'elementor/element/after_add_attributes', 'proactive_custom_el_attributes', 10, 1 );
function proactive_custom_el_attributes($el){
...
add_filter( 'pxl-custom-section/before-render', 'proactive_custom_section_before_render', 10, 3 );
function proactive_custom_section_before_render($html ,$settings, $el) {
...
add_filter( 'pxl-custom-column/before-render', 'proactive_custom_column_before_render', 10, 3 );
function proactive_custom_column_before_render($html, $settings, $el){
