...
$templates = $templates_df + proactive_get_templates_option('page') ;
pxl_add_custom_widget(
    array(
        'name' => 'pxl_button',
        'title' => esc_html__('Case Button', 'proactive' ),
        'icon' => 'eicon-button',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'btn_style',
                            'label' => esc_html__('Type', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'btn-default',
                            'options' => [
                                'btn-default' => esc_html__('Default', 'proactive' ),
                                'btn-text-underline' => esc_html__('Text Underline', 'proactive' ),
                                'btn-gradient-rotate' => esc_html__('Gradient Rotate', 'proactive' ),
                                'btn-gradient-horizontal' => esc_html__('Gradient Horizontal 1', 'proactive' ),
                                'btn-gradient-horizontal2' => esc_html__('Gradient Horizontal 2', 'proactive' ),
                                'btn-icon-box' => esc_html__('Icon Box 1', 'proactive' ),
                                'btn-icon-box2' => esc_html__('Icon Box 2', 'proactive' ),
                                'btn-icon-box3' => esc_html__('Icon Box 3', 'proactive' ),
                                'btn-icon-box4' => esc_html__('Icon Box 4', 'proactive' ),
                            ],
                        ),
                        array(
                            'name' => 'text',
                            ...
                            'default' => esc_html__('Click Here', 'proactive'),
                        ),
                        array(
                            'name' => 'btn_action',
                            'label' => esc_html__('Action', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'pxl-atc-link',
                            'options' => [
                                'pxl-atc-link' => esc_html__('Link', 'proactive' ),
                                'pxl-atc-popup' => esc_html__('Popup', 'proactive' ),
                            ],
                        ),
                        array(
                            'name' => 'link',
                        ...
                        array(
                            'name' => 'popup_template',
                            'label' => esc_html__('Select Popup Template', 'proactive'),
                            'type' => 'select',
                            'options' => $templates,
                            'default' => 'df',
                        ...
                        array(
                            'name' => 'icon_align',
                            'label' => esc_html__('Icon Position', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => 'left',
                            'options' => [
                                'left' => esc_html__('Before', 'proactive' ),
                                'right' => esc_html__('After', 'proactive' ),
                            ],
                        ),
                    ),
                ),
                ...
                array(
                    ...
                    'label' => esc_html__('Button Normal', 'proactive' ),
                    ...
                    'controls' => array_merge(
                        array(
                            ...
                            array(
                                'name' => 'btn_bg_color',
                                'label' => esc_html__('Background Color', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                        ...
                        array(
                            ...
                            array(
                                'name' => 'btn_padding',
                                'label' => esc_html__('Padding', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Text Inner Margin', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                'name' => 'btn_full_width',
                                'label' => esc_html__( 'Full Width', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    'btn-block-inline' => esc_html__( 'No', 'proactive' ),
                                    'btn-block' => esc_html__( 'Yes', 'proactive' ),
                                ],
                ...
                array(
                    ...
                    'label' => esc_html__('Button Hover', 'proactive' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'color_hover',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Text Effect', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'default' => '',
                            'options' => [
                                '' => esc_html__('Default', 'proactive' ),
                                'btn-text-nina' => esc_html__('Nina', 'proactive' ),
                                'btn-text-nanuk' => esc_html__('Nanuk', 'proactive' ),
                                'btn-text-parallax' => esc_html__('Parallax', 'proactive' ),
                            ],
                        ),
                    ),
                ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Icon Spacer', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'icon_box_color',
                            'label' => esc_html__( 'Box Color Main', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'default' => '',
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Box Color Gradient', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'default' => '',
                            'selectors' => [
