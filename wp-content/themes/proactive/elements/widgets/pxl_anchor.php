...
$templates_lv1 = ['1' => esc_html__('Hidden Panel Mobile', 'proactive')];
$templates = $templates_df + $templates_lv1 + proactive_get_templates_option('hidden-panel') ;
pxl_add_custom_widget(
    array(
        'name' => 'pxl_anchor',
        'title' => esc_html__('Case Anchor', 'proactive' ),
        'icon' => 'eicon-anchor',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'pxl_icon',
                            'label' => esc_html__('Select Icon', 'proactive' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Close Popup - Animation Delay', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'default' => '0',
