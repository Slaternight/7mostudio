...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Image Marquee', 'proactive'),
        'icon' => 'eicon-logo',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'marquee',
                            'label' => esc_html__('Logo Marquee', 'proactive'),
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'slip_type',
                            'label' => esc_html__('Slip Type', 'proactive' ),
                        ...
                        array(
                            'name' => 'slip_duration',
                            'label' => esc_html__('Slip Duration', 'proactive' ),
