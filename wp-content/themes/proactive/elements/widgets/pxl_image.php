...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_image',
        'title' => esc_html__('Case Image', 'proactive' ),
        'icon' => 'eicon-image',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'image',
                            'label' => esc_html__('Choose Image', 'proactive' ),
                        ...
                        array(
                            'name' => 'image_type',
                            'label' => esc_html__('Image Type', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'img' => 'Image',
                                'bg' => 'Background',
                        ...
                        array(
                            'name' => 'img_label',
                            'label' => esc_html__('Image Label', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                        ),
                        array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'label' => esc_html__('Image Max Height', 'proactive' ),
                        ...
                        array(
                            'name' => 'image_width',
                            'label' => esc_html__('Image Width', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'auto' => [
                                    'title' => esc_html__( 'Auto', 'proactive' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Border Radius Hover', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px' ],
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Parallax Value', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-parallax-scroll',
                            ],
                        ...
                        array(
                            'name' => 'max_tilt',
                            'label' => esc_html__('Max Tilt', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                        ...
                        array(
                            'name' => 'speed_tilt',
                            'label' => esc_html__('Speed Tilt', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            ...
                            'label' => esc_html__('Perspective Tilt', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'condition' => [
                                'img_effect' => 'pxl-image-tilt',
                            ],
                        ...
                        array(
                            'name' => 'speed_effect',
                            'label' => esc_html__('Speed', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Disable Parallax on Mobile <= 767px', 'proactive'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                            'default' => 'false',
                            'condition' => [
                                'img_effect' => ['pxl-parallax-scroll'],
                        ...
                        array(
                            'name' => 'opacity',
                            'label' => esc_html__('Opacity (0 - 100)', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ '%' ],
                            'default'    => [
