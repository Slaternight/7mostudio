...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Partner Carousel', 'proactive'),
        'icon' => 'eicon-person',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'partner',
                            'label' => esc_html__('Partner', 'proactive'),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'arrows_label',
                            'label' => esc_html__('Arrows Label', 'proactive'),
                        ...
                        array(
                            'name' => 'autoplay_speed',
                            'label' => esc_html__('Autoplay Speed', 'proactive'),
