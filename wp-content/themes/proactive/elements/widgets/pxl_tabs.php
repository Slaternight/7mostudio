<?php
$templates = proactive_get_templates_option('tab', []) ;
pxl_add_custom_widget(
    array(
        'name' => 'pxl_tabs',
        'title' => esc_html__( 'Case Tabs', 'proactive' ),
        'icon' => 'eicon-tabs',
        ...
        'params' => array(
            'sections' => array(
                array(
                    'name' => 'tab_content',
                    'label' => esc_html__( 'Tabs', 'proactive' ),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'tab_active',
                            'label' => esc_html__( 'Active Tab', 'proactive' ),
                        ...
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'content_type',
                                    'label' => esc_html__('Content Type', 'proactive'),
                                    'type' => 'select',
                                    'options' => [
                                        'df' => esc_html__( 'Default', 'proactive' ),
                                        'template' => esc_html__( 'From Template Builder', 'proactive' )
                                    ],
                                    'default' => 'df' 
                                ),
                                array(
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Select Template', 'proactive'),
                                    'type' => 'select',
                                    'options' => $templates,
                                    'default' => 'df',
                        ...
                        array(
                            'name' => 'max_width',
                            'label' => esc_html__('Content Max Width', 'proactive' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            ...
                            'label' => esc_html__('Content Top Spacer', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'default' => [
