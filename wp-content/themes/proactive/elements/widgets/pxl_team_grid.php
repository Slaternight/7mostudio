...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_team_grid',
        'title' => esc_html__('Case Team Grid', 'proactive'),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'team',
                            'label' => esc_html__('Team', 'proactive'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'item_link',
                                    'label' => esc_html__('Link Details', 'proactive'),
                                    'type' => \Elementor\Controls_Manager::URL,
                                    'label_block' => true,
                                ),
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'proactive' ),
                                    'type' => 'pxl_icons',
                                ),
                            ),
                            'title_field' => '{{{ title }}}',
                ...
                array(
                    ...
                    'label' => esc_html__('Grid', 'proactive' ),
                ...
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'pos_color',
                            'label' => esc_html__('Position Color', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'pos_typography',
                            'label' => esc_html__('Position Typography', 'proactive' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
