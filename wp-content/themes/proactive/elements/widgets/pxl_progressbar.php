...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__( 'Case Progress Bar', 'proactive' ),
        'icon' => 'eicon-skill-bar',
        'categories' => array('pxltheme-core'),
        'scripts' => array(
            'pxl-progressbar',
            'proactive-progressbar',
        ),
        'params' => array(
            'sections' => array(
                array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'progressbar',
                            'label' => esc_html__( 'Progress Bar', 'proactive' ),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'percent',
                                    'label' => esc_html__( 'Percentage', 'proactive' ),
                        ...
                        array(
                            'name' => 'item_max_width',
                            'label' => esc_html__('Item Max Width', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'label' => esc_html__( 'Percentage Color', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__( 'Percentage Typography', 'proactive' ),
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                ...
                array(
                    'name' => 'tab_style_bar',
                    'label' => esc_html__( 'Bar', 'proactive' ),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'bar_color',
                            'label' => esc_html__( 'Bar Color', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'bar_bg_color',
                            'label' => esc_html__( 'Bar Background Color', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'bar_height',
                            'label' => esc_html__('Bar Height', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'control_type' => 'responsive',
                            'size_units' => [ 'px' ],
                            'range' => [
                        ...
                        array(
                            'name' => 'bar_radius',
                            'label' => esc_html__('Bar Radius', 'proactive' ),
