...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Video Button', 'proactive' ),
        'icon' => 'eicon-play',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'video_icon',
                            'label' => esc_html__('Video Icon', 'proactive' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Image Border Radius', 'proactive' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Style', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'style1' => 'Style White',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Button Video Position', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'p-center' => 'Center',
                                'p-top-left' => 'Top Left',
