...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_menu',
        'title' => esc_html__('Case Nav Menu', 'proactive'),
        'icon' => 'eicon-nav-menu',
            ...
            'sections' => array(
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'menu',
                            'label' => esc_html__('Select Menu', 'proactive'),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => $pxl_menus,
                        ),
                        array(
                            'name' => 'menu_type',
                            'label' => esc_html__('Menu Type', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            'name' => 'text_align',
                            'label' => esc_html__('Text Alignment', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::CHOOSE,
                            'options' => [
                                'left' => [
                                    'title' => esc_html__('Left', 'proactive' ),
                        ...
                        array(
                            'name' => 'max_height',
                            'label' => esc_html__('Max Height', 'proactive' ),
                ...
                array(
                    ...
                    'label' => esc_html__('First Level', 'proactive'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'color_active',
                            'label' => esc_html__('Color Active', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'arrow_color',
                            'label' => esc_html__('Arrow Color', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Has Children - Font Size', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            'name' => 'menu_mega_type',
                            'label' => esc_html__('Menu Mega Type', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Menu Mega Border Radius', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::DIMENSIONS,
                            'size_units' => [ 'px' ],
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Left', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Spacer Right', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Mega Menu Container Max Width', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Arrow Parent', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                                'none' => 'None',
                                'plus' => 'Plus',
                ...
                array(
                    ...
                    'label' => esc_html__('Sub Level', 'proactive'),
                    'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                    'controls' => array(
                        array(
                            'name' => 'sub_color',
                        ...
                        array(
                            ...
                            'label' => esc_html__('Color Hover/Actvie', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            'name' => 'sub_bg_color',
                            'label' => esc_html__('Box Background Color', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Hover/Active Style', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Show Effect', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SELECT,
                            'options' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
                        ...
                        array(
                            ...
                            'label' => esc_html__('Box Spacer Top - Mega', 'proactive' ),
                            'type' => \Elementor\Controls_Manager::SLIDER,
                            'size_units' => [ 'px' ],
                            'range' => [
                                'px' => [
