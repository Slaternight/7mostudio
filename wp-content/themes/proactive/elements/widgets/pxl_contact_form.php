...
if(class_exists('WPCF7')) {
    ...
    if ($cf7) {
        ...
        $contact_forms[esc_html__('No contact forms found', 'proactive')] = 0;
    }

    pxl_add_custom_widget(
        array(
            'name' => 'pxl_contact_form',
            'title' => esc_html__('Case Contact Form', 'proactive'),
                ...
                'sections' => array(
                    array(
                        ...
                        'controls' => array(
                            array(
                                'name' => 'form_id',
                                'label' => esc_html__('Select Form', 'proactive'),
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input', 'proactive'),
                        ...
                        'controls' => array(
                            ...
                            array(
                                'name' => 'input_padding',
                                'label' => esc_html__('Padding Input', 'proactive' ),
                            ...
                            array(
                                'name' => 'input_height',
                                'label' => esc_html__('Input Height', 'proactive' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Height', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Padding Textarea', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'size_units' => [ 'px' ],
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Type', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SELECT,
                                'options' => [
                                    '' => esc_html__( 'None', 'proactive' ),
                                    'solid' => esc_html__( 'Solid', 'proactive' ),
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Textarea Border Width', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Textarea Typography', 'proactive' ),
                                'type' => \Elementor\Group_Control_Typography::get_type(),
                                'control_type' => 'group',
                            ...
                            array(
                                'name' => 'textarea_color',
                                'label' => esc_html__('Textarea Color', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer Bottom', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer Left', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Item Spacer right', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                    ...
                    array(
                        ...
                        'label' => esc_html__('Input Hover', 'proactive'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                    ...
                    array(
                        ...
                        'label' => esc_html__('Button', 'proactive'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array_merge(
                            array(
                                array(
                                    'name' => 'button_typography',
                                    'label' => esc_html__('Button Typography', 'proactive' ),
                                    'type' => \Elementor\Group_Control_Typography::get_type(),
                                    'control_type' => 'group',
                                ...
                                array(
                                    'name' => 'button_color',
                                    'label' => esc_html__('Button Color', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Color Hover', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                ...
                                array(
                                    ...
                                    'label' => esc_html__('Button Background Color Hover', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                            ...
                            array(
                                ...
                                array(
                                    'name' => 'btn_spacer_top',
                                    'label' => esc_html__('Spacer Top', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::SLIDER,
                                    'control_type' => 'responsive',
                                    'size_units' => [ 'px' ],
                                    'range' => [
                    ...
                    array(
                        'name' => 'extra',
                        'label' => esc_html__('Extra', 'proactive'),
                        'tab' => \Elementor\Controls_Manager::TAB_STYLE,
                        'controls' => array(
                            array(
                                'name' => 'f_width',
                                'label' => esc_html__('Form Max Width', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px', '%' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Notification Color', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                'name' => 'validate_color',
                                'label' => esc_html__('Validate Color', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::COLOR,
                                'selectors' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__('Label Spacer Bottom', 'proactive' ),
                                'type' => \Elementor\Controls_Manager::SLIDER,
                                'control_type' => 'responsive',
                                'size_units' => [ 'px' ],
                                'range' => [
                            ...
                            array(
                                ...
                                'label' => esc_html__( 'Radio Box Shadow', 'proactive' ),
                                'type'         => \Elementor\Group_Control_Box_Shadow::get_type(),
                                'control_type' => 'group',
