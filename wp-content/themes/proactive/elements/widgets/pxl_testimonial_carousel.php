...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Case Testimonial Carousel', 'proactive'),
            ...
            'sections' => array(
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'testimonial',
                            'label' => esc_html__('Testimonial', 'proactive'),
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'position',
                                    'label' => esc_html__('Position', 'proactive'),
                                    'type' => \Elementor\Controls_Manager::TEXT,
                                ),
                                array(
                                    'name' => 'desc',
                                ...
                                array(
                                    'name' => 'image',
                                    'label' => esc_html__('Avatar', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::MEDIA,
                                ),
                                array(
                                    'name' => 'image_thumbnail',
                                    'label' => esc_html__('Thumbnail', 'proactive' ),
                                    'type' => \Elementor\Controls_Manager::MEDIA,
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            'name' => 'wg_sub_title',
                            'label' => esc_html__('Widget Sub Title', 'proactive'),
                            'type' => \Elementor\Controls_Manager::TEXT,
                            'label_block' => true,
                        ),
                        array(
                        ...
                        array(
                            'name' => 'wg_title_color',
                            'label' => esc_html__('Widget Title Color', 'proactive' ),
                        ...
                        array(
                            ...
                            'label' => esc_html__('Widget Title Typography', 'proactive' ),
                        ...
                        array(
                            'name' => 'h_width',
                            'label' => esc_html__('Widget Title Max Width', 'proactive' ),
                ...
                array(
                    ...
                    'label' => esc_html__('Settings', 'proactive'),
