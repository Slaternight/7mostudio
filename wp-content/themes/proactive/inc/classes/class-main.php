...
if (!class_exists('Proactive_Main')) { 
    class Proactive_Main extends Proactive_Base
    {
        ...
        public static function getInstance()
        {
            ...
            if (null === self::$instance) {
                self::$instance = new Proactive_Main();
            }
...
function proactive() {
    return Proactive_Main::getInstance();
}
// Install
proactive(); 
